                ...
                <div class="col-lg-6">
                    <div class="messages-block block">
                        ...
                        <div class="messages"><a href="#" class="message d-flex align-items-center">
                                <div class="profile"><img src="{{ asset('admin/img/avatar-3.jpg') }}"
                                        alt="..." class="img-fluid">
                                ...
                                <div class="profile"><img src="{{ asset('admin/img/avatar-2.jpg') }}"
                                        alt="..." class="img-fluid">
                                ...
                                <div class="profile"><img src="{{ asset('admin/img/avatar-1.jpg') }}"
                                        alt="..." class="img-fluid">
                                ...
                                <div class="profile"><img src="{{ asset('admin/img/avatar-5.jpg') }}"
                                        alt="..." class="img-fluid">
